...
class Program(models.Model):
    ...
    department = models.ForeignKey(
        Department(), on_delete=models.CASCADE, blank=True, default=1)
...
class Student(models.Model):
        ...
        program = models.ForeignKey(Program, on_delete=models.CASCADE ,blank=True ,default=1)
...
class TakenCourse(models.Model):
    ...
    program = models.ForeignKey(Program, on_delete=models.CASCADE ,blank=True ,default=1)
    session = models.ForeignKey(
        Session, on_delete=models.CASCADE, blank=True, default=1)
    ...
    def get_comment(self, ca,grade, exam):
        if not grade == "F":
            comment = PASS
        elif int(ca) <= 23:
            comment = CARRY
