...
class StudentAddForm(UserCreationForm):
    ...
    def save(self):
        ...
        user.email=self.cleaned_data.get('email')
        user.save()
        student = Student.objects.create(user=user, id_number=id_number, level=self.cleaned_data.get('level'), department=self.cleaned_data.get('department'),program=self.cleaned_data.get('program'))
        student.save()
        return user
